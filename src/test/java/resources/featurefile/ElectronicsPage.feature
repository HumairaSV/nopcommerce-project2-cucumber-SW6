Feature: Electronics Page Test
  ...
  Scenario: Verify user is able to add product to cart and place order successfully
    ...
    And   On registration page I enter first name "TestVh"
    And   On registration page I enter Last name "Cocomelon"
    And   On registration page I enter email "cocomelon3@gmail.com"
    And   On registration page I enter password "Password123"
    And   On registration page I enter confirm password "Password123"
    ...
    And   On Login page I enter email "cocomelon3@gmail.com" and password "Password123"
    And   I click on the login button
    And   I click on the checkbox - I agree with the terms of service
    And   I click on checkout button
    And   I select Country "United Kingdom" from the drop down list
    And   I enter City "Manchester"
    And   I enter Address "269,Cambridge Lane"
    And   I enter post code "M12 9AW"
    And   I enter phone number "5665995116994"
    ...
    And   I enter card holder name "TestVh Cocomelon"
